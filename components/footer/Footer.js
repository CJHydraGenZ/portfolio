      ...
      <div className="container">
        <div className="flex flex-wrap">
          <div className="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
            <h2 className="font-bold text-4xl text-white mb-5">Gede Cahya</h2>
            <h3 className="font-bold text-2xl mb-2">hubungi Kami</h3>
            <p>cahya@gmail.com</p>
            <p>Jl. Pekutatan - Pupuan</p>
            <p>Buleleng</p>
          </div>
        ...
        <div className="w-full pt-10 border-t border-slate-700">
          ...
          <p className="font-medium text-xs text-slate-500 text-center">
            Dibuat oleh{" "}
            <Link href="#">
              <a target="_blank" className="font-bold text-primary">
                Gede Cahya✌
              </a>
            </Link>
            , menggunakan
            <Link href="https://nextjs.org/">
              <a target="_blank" className="font-bold text-white ml-1">
                Next
              </a>
            </Link>
            <span className="mx-2">-</span>
            <Link href="https://tailwindcss.com/">
              <a target="_blank" className="font-bold text-sky-500">
                Tailwind CSS.
              </a>
            </Link>
          </p>
